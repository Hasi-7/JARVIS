...
function CourseCard({ course }: { course: VaultCourse }) {
  return (
  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--s5)' }}>
      ...
      <div style={{ fontSize: 11, color: 'var(--txt-3)', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        Read-only. No vault files are modified. Data from <span className="mono">wiki/courses/</span> and <span className="mono">raw/courses/</span>.
      </div>
